            ...
            echo "<table width='99.6%' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                    ...
                    while($baris = mysqli_fetch_array($hasil)) {
                        echo "<tr class='isi' title='$baris[1] $baris[2]'>
                                ...
                                $_sqlkinerja  = "Select pencapaian_kinerja_pegawai.tahun,pencapaian_kinerja_pegawai.bulan,
                                                pencapaian_kinerja.nama_pencapaian,pencapaian_kinerja_pegawai.keterangan 
                                                from pencapaian_kinerja_pegawai inner join pencapaian_kinerja on
                                                pencapaian_kinerja_pegawai.kode_pencapaian=pencapaian_kinerja.kode_pencapaian 
                                                where pencapaian_kinerja_pegawai.id='$baris[0]' order by 
