 ...
 * @author perpustakaan
 */
public final class DlgHitungBORDinkes extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgHitungBORDinkes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Hitung BOR DINKES ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Data Hitung BOR Dinkes ]::");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgHitungBORDinkes dialog = new DlgHitungBORDinkes(new javax.swing.JFrame(), true);
        ...
        try{   
            ...
            try {
                ...
                if(hari>0){
                    ...
                    tabMode.addRow(new Object[]{"","","","Perhitungan BOR ",": ("+hari+"/("+kamar+" X "+jumlahhari+")) X 100%","","",Valid.SetAngka4((hari/(104*jumlahhari))*100)+" %",""});
                }                    
            } catch (Exception e) {
