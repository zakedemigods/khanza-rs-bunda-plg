    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        for(i=0;i<tbData.getRowCount();i++){ 
            if(tbData.getValueAt(i,0).toString().equals("true")){
                if(tbData.getValueAt(i,1).toString().equals("Cetak SEP")){ //CETAK SEP ASTAGAZAKE
                    ...
                    param.put("umurnow",Sequel.cariIsi("SELECT umur FROM pasien join bridging_sep on bridging_sep.nomr = pasien.no_rkm_medis WHERE bridging_sep.no_sep=?",NoSEP));
                    param.put("admin",Sequel.cariIsi("SELECT nama FROM pegawai join bridging_sep on bridging_sep.user = pegawai.nik WHERE bridging_sep.no_sep=?",NoSEP));
                    ...
                    if(TglRujukan.equals("")){
                        if(JenisPelayanan.equals("ranap")){
                            Valid.MyReportqry("rptBridgingSEPbundazV.jasper","report","::[ Cetak SEP RS Bunda ]::","select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"+
                            ...
                            Valid.MyReportqry("rptBridgingSEPbundaralanzV.jasper","report","::[ Cetak SEP RS Bunda ]::","select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"+
                                    "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"+
                                    "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"+
                                    "if(bridging_sep.jnspelayanan='1','Rawat Inap','Rawat Jalan'),bridging_sep.catatan,bridging_sep.diagawal,"+
                                    "bridging_sep.nmdiagnosaawal,bridging_sep.kdpolitujuan,bridging_sep.nmpolitujuan,"+
                        ...
                        if(JenisPelayanan.equals("ranap")){
                            Valid.MyReportqry("rptBridgingSEPbundaInternalzV.jasper","report","::[ Cetak SEP Internal RS Bunda ]::","select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"+
                            ...
                            Valid.MyReportqry("rptBridgingSEPbundaralanInternalzV.jasper","report","::[ Cetak SEP Internal RS Bunda ]::","select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"+
                                    "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"+
                                    "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"+
                                    "if(bridging_sep_internal.jnspelayanan='1','Rawat Inap','Rawat Jalan'),bridging_sep_internal.catatan,bridging_sep_internal.diagawal,"+
                                    "bridging_sep_internal.nmdiagnosaawal,bridging_sep_internal.kdpolitujuan,bridging_sep_internal.nmpolitujuan,"+
                ...
                }else if(tbData.getValueAt(i,1).toString().equals("Cetak SJP")){ //CETAK SJP ASTAGAZAKE
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();                 
                    param.put("namars",akses.getnamars());
                    param.put("alamatrs",akses.getalamatrs());
                    ...
                    param.put("logo",Sequel.cariGambar("select bpjs from gambar")); 
                    param.put("prb",Sequel.cariIsi("select prb from bpjs_prb where no_sep=?",NoSEP)); 
                    param.put("tgl_sep",Sequel.cariIsi("SELECT DATE_FORMAT(tglsep, '%d %M %Y') FROM `bridging_sep` WHERE no_sep=?", NoSEP));
                    param.put("tgl_rujukan",Sequel.cariIsi("SELECT DATE_FORMAT(tglrujukan, '%d %M %Y') FROM `bridging_sep` WHERE no_sep=?", NoSEP));
                    param.put("tgl_lahir",Sequel.cariIsi("SELECT DATE_FORMAT(tgl_lahir, '%d %M %Y') FROM pasien join bridging_sep on pasien.no_rkm_medis = bridging_sep.nomr WHERE bridging_sep.no_sep=?", NoSEP));
                    param.put("alamat",Sequel.cariIsi("SELECT alamat FROM pasien join bridging_sep on pasien.no_rkm_medis = bridging_sep.nomr WHERE bridging_sep.no_sep=?", NoSEP));
                    if(TglRujukan.equals("")){
                        if(JenisPelayanan.equals("ranap")){
                            Valid.MyReportqry("rptBridgingSJPRANAP-Internal.jasper","report","::[ Cetak SJP RS Bunda ]::","select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"+
                                    "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"+
                                    "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"+
                                    "if(bridging_sep.jnspelayanan='1','Rawat Inap','Rawat Jalan'),bridging_sep.catatan,bridging_sep.diagawal,"+
                                    "bridging_sep.nmdiagnosaawal,bridging_sep.kdpolitujuan,bridging_sep.nmpolitujuan,"+
                            ...
                            Valid.MyReportqry("rptBridgingSJPRALAN-Internal.jasper","report","::[ Cetak SJP RS Bunda ]::","select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"+
                                    "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"+
                                    "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"+
                                    "if(bridging_sep.jnspelayanan='1','Rawat Inap','Rawat Jalan'),bridging_sep.catatan,bridging_sep.diagawal,"+
                                    "bridging_sep.nmdiagnosaawal,bridging_sep.kdpolitujuan,bridging_sep.nmpolitujuan,"+
                        ...
                        if(JenisPelayanan.equals("ranap")){
                            Valid.MyReportqry("rptBridgingSJPRANAP.jasper","report","::[ Cetak SJP Internal RS Bunda ]::","select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"+
                                    "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"+
                                    "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"+
                                    "if(bridging_sep_internal.jnspelayanan='1','Rawat Inap','Rawat Jalan'),bridging_sep_internal.catatan,bridging_sep_internal.diagawal,"+
                                    "bridging_sep_internal.nmdiagnosaawal,bridging_sep_internal.kdpolitujuan,bridging_sep_internal.nmpolitujuan,"+
                            ...
                            Valid.MyReportqry("rptBridgingSJPRALAN.jasper","report","::[ Cetak SJP Internal RS Bunda ]::","select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"+
                                    "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"+
                                    "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"+
                                    "if(bridging_sep_internal.jnspelayanan='1','Rawat Inap','Rawat Jalan'),bridging_sep_internal.catatan,bridging_sep_internal.diagawal,"+
                                    "bridging_sep_internal.nmdiagnosaawal,bridging_sep_internal.kdpolitujuan,bridging_sep_internal.nmpolitujuan,"+
                    ...
                    this.setCursor(Cursor.getDefaultCursor());
                }else if(tbData.getValueAt(i,1).toString().equals("Label Barcode Bunda")){ //LABELBARODE ASTAGAZAKE
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    ...
                    param.put("jkel",Sequel.cariIsi("select jkel from bridging_sep where no_sep=?",NoSEP));
                    param.put("tgl_lahir",Sequel.cariIsi("select tanggal_lahir from bridging_sep where no_sep=?",NoSEP));
                    param.put("umurnow",Sequel.cariIsi("SELECT umur FROM pasien join reg_periksa on reg_periksa.no_rkm_medis = pasien.no_rkm_medis WHERE reg_periksa.no_rawat=?",NoRawat));
                    param.put("png_jawab",Sequel.cariIsi("SELECT penjab.nama_perusahaan FROM ((penjab INNER JOIN pasien ON penjab.kd_pj = pasien.kd_pj) INNER JOIN reg_periksa ON pasien.no_rkm_medis = reg_periksa.no_rkm_medis) WHERE reg_periksa.no_rawat=?",NoRawat));
                    param.put("kd_poli",Sequel.cariIsi("select kd_poli from reg_periksa where no_rkm_medis=?",NoRm));
                    param.put("tgl_registrasi",Sequel.cariIsi("select tgl_registrasi from reg_periksa where no_rkm_medis=?",NoRm));
                    param.put("no_rawat",Sequel.cariIsi("select no_rawat from bridging_sep where no_sep=?",NoSEP));
                    param.put("nm_dokter",Sequel.cariIsi("select nmdpdjp from bridging_sep where no_sep=?",NoSEP));
                    param.put("norm",NoRm);    
                    param.put("namars",akses.getnamars());
                    param.put("alamatrs",akses.getalamatrs());
                    param.put("kotars",akses.getkabupatenrs());
                    ...
                    Valid.MyReportqry("rptBarcodeRawatPopup.jasper","report","::[ Barcode No.Rawat ]::",
                            "select reg_periksa.no_rawat from reg_periksa where no_rawat='"+NoRawat+"'",param); 
                    this.setCursor(Cursor.getDefaultCursor());
           }else if(tbData.getValueAt(i,1).toString().equals("Kartu Pasien 1")){
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();                 
                    param.put("namars",akses.getnamars());
                    param.put("alamatrs",akses.getalamatrs());
    ...
    */
    ...
    public void tampil() {
        try{         
            ...
            TabMode.addRow(new Object[]{false,"Cetak SEP"});//0,0
            TabMode.addRow(new Object[]{false,"Cetak SJP"});//0,0
            TabMode.addRow(new Object[]{false,"Label Barcode Bunda"});//0,0
            TabMode.addRow(new Object[]{false,"Cetak SEP"});//0,0
            TabMode.addRow(new Object[]{false,"Cetak SJP"});//0,0
            TabMode.addRow(new Object[]{false,"Label Barcode Bunda"});//0,0
