...
public class DlgKamarInap extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,pssetjam,pscaripiutang,psdiagnosa,psibu,psanak,psanak2,psanak3,pstarif,psdpjp,pscariumur,psceklab,psceklabpa,pscekrad,pscekresep,pscarilabpa;
    private ResultSet rs,rs2,rssetjam,rsceklab, rscekrad, rscekresep,rsceklabpa,rscarilabpa;
    private int i,row=0,ceknomor=0;
    private double lama=0,persenbayi=0,hargakamar=0;
    private String tgl_masuk_inap="",jam_masuk_inap="",gabungkan="",norawatgabung="",kamaryangdigabung="",dokterranap="",bangsal="",diagnosa_akhir="",namakamar="",umur="0",sttsumur="Th",order="order by bangsal.nm_bangsal,kamar_inap.tgl_masuk,kamar_inap.jam_masuk";
    ...
    public DlgKamarInap(java.awt.Frame parent, boolean modal) {
        ...
        WindowRanapGabung.setSize(600,170);
...
//                            System.out.println("gabung");
                        ...
                        } else if (gabungkan.equals("gabung2")) {
                            NoRmBayi1.setText(billing.rawatinap.pasien.getTable().getValueAt(billing.rawatinap.pasien.getTable().getSelectedRow(),0).toString());                    
                            NmBayi1.setText(billing.rawatinap.pasien.getTable().getValueAt(billing.rawatinap.pasien.getTable().getSelectedRow(),1).toString());  
//                            System.out.println("gabung2");
                            NoRmBayi1.requestFocus();
                        } else if(gabungkan.equals("gabung3")){
                            NoRmBayi2.setText(billing.rawatinap.pasien.getTable().getValueAt(billing.rawatinap.pasien.getTable().getSelectedRow(),0).toString());                    
                            NmBayi2.setText(billing.rawatinap.pasien.getTable().getValueAt(billing.rawatinap.pasien.getTable().getSelectedRow(),1).toString()); 
//                            System.out.println("gabung3");
                            NoRmBayi2.requestFocus();
                        }                    
                    }
                }
            }
...
//                            System.out.println("gabung");
                            ...
                            NoRmBayi1.setText(ikb.getTable().getValueAt(ikb.getTable().getSelectedRow(),0).toString());                    
                            NmBayi1.setText(ikb.getTable().getValueAt(ikb.getTable().getSelectedRow(),1).toString()); 
//                            System.out.println("gabung2");
                            NoRmBayi1.requestFocus();
                        } else if (gabungkan.equals("gabung3")) {
                            NoRmBayi2.setText(ikb.getTable().getValueAt(ikb.getTable().getSelectedRow(),0).toString());                    
                            NmBayi2.setText(ikb.getTable().getValueAt(ikb.getTable().getSelectedRow(),1).toString()); 
//                            System.out.println("gabung3");
                            NoRmBayi2.requestFocus();
                        }                   
                    }  
    ...
    private void initComponents() {
        ...
        MnPenilaianAwalKeperawatanRanapUmum = new javax.swing.JMenuItem();
        ...
        barcodeRM = new javax.swing.JMenuItem();
        barcodeRI = new javax.swing.JMenuItem();
        MnRanapGabung = new javax.swing.JMenuItem();
        MnGabungkanRanap = new javax.swing.JMenuItem();
        MnGabungkanRanap1 = new javax.swing.JMenuItem();
        MnGabungkanRanap2 = new javax.swing.JMenuItem();
        ...
        NoRmBayi1 = new widget.TextBox();
        jLabel41 = new widget.Label();
        BtnHapusGabung1 = new widget.Button();
        NmBayi2 = new widget.TextBox();
        NoRmBayi2 = new widget.TextBox();
        jLabel42 = new widget.Label();
        BtnHapusGabung2 = new widget.Button();
        ...
        MnPenilaianAwalKeperawatanRanapUmum.setBackground(new java.awt.Color(255, 255, 254));
        MnPenilaianAwalKeperawatanRanapUmum.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnPenilaianAwalKeperawatanRanapUmum.setForeground(new java.awt.Color(50, 50, 50));
        MnPenilaianAwalKeperawatanRanapUmum.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPenilaianAwalKeperawatanRanapUmum.setText("Penilaian Awal Keperawatan Ranap Umum");
        MnPenilaianAwalKeperawatanRanapUmum.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnPenilaianAwalKeperawatanRanapUmum.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnPenilaianAwalKeperawatanRanapUmum.setName("MnPenilaianAwalKeperawatanRanapUmum"); // NOI18N
        MnPenilaianAwalKeperawatanRanapUmum.setPreferredSize(new java.awt.Dimension(310, 26));
        MnPenilaianAwalKeperawatanRanapUmum.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnPenilaianAwalKeperawatanRanapUmumActionPerformed(evt);
            }
        });
        MnDataRM.add(MnPenilaianAwalKeperawatanRanapUmum);
        ...
        barcodeRM.setBackground(new java.awt.Color(255, 255, 254));
        barcodeRM.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        barcodeRM.setForeground(new java.awt.Color(50, 50, 50));
        barcodeRM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        barcodeRM.setText("Barcode RM");
        barcodeRM.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        barcodeRM.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        barcodeRM.setName("barcodeRM"); // NOI18N
        barcodeRM.setPreferredSize(new java.awt.Dimension(200, 26));
        barcodeRM.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                barcodeRMActionPerformed(evt);
            }
        });
        MnGelang.add(barcodeRM);

        barcodeRI.setBackground(new java.awt.Color(255, 255, 254));
        barcodeRI.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        barcodeRI.setForeground(new java.awt.Color(50, 50, 50));
        barcodeRI.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        barcodeRI.setText("Barcode Rawat Inap");
        barcodeRI.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        barcodeRI.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        barcodeRI.setName("barcodeRI"); // NOI18N
        barcodeRI.setPreferredSize(new java.awt.Dimension(200, 26));
        barcodeRI.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                barcodeRIActionPerformed(evt);
            }
        });
        MnGelang.add(barcodeRI);
        ...
        MnRanapGabung.setText("Hapus Gabung Ibu & Bayi");
        ...
        MnGabungkanRanap.setText("Gabungkan Ke Kamar Ibu Bayi 1");
        ...
        MnGabungkanRanap1.setBackground(new java.awt.Color(255, 255, 254));
        MnGabungkanRanap1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnGabungkanRanap1.setForeground(new java.awt.Color(50, 50, 50));
        MnGabungkanRanap1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnGabungkanRanap1.setText("Gabungkan Ke Kamar Ibu Bayi 2");
        MnGabungkanRanap1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnGabungkanRanap1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnGabungkanRanap1.setName("MnGabungkanRanap1"); // NOI18N
        MnGabungkanRanap1.setPreferredSize(new java.awt.Dimension(220, 26));
        MnGabungkanRanap1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnGabungkanRanap1ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnGabungkanRanap1);

        MnGabungkanRanap2.setBackground(new java.awt.Color(255, 255, 254));
        MnGabungkanRanap2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnGabungkanRanap2.setForeground(new java.awt.Color(50, 50, 50));
        MnGabungkanRanap2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnGabungkanRanap2.setText("Gabungkan Ke Kamar Ibu Bayi 3");
        MnGabungkanRanap2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnGabungkanRanap2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnGabungkanRanap2.setName("MnGabungkanRanap2"); // NOI18N
        MnGabungkanRanap2.setPreferredSize(new java.awt.Dimension(220, 26));
        MnGabungkanRanap2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnGabungkanRanap2ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnGabungkanRanap2);
        ...
        internalFrame6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ranap Gabung Ibu & Bayi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        internalFrame6.setName("internalFrame6"); // NOI18N
        internalFrame6.setPreferredSize(new java.awt.Dimension(692, 138));
        ...
        BtnCloseGabung.setBounds(330, 120, 100, 30);

        jLabel34.setText("No.R.M.Bayi 1 :");
        jLabel34.setName("jLabel34"); // NOI18N
        internalFrame6.add(jLabel34);
        jLabel34.setBounds(10, 20, 87, 23);
        ...
        BtnHapusGabung.setBounds(500, 15, 100, 30);
        ...
        internalFrame6.add(NmBayi1);
        NmBayi1.setBounds(200, 50, 300, 23);

        NoRmBayi1.setName("NoRmBayi1"); // NOI18N
        NoRmBayi1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NoRmBayi1KeyPressed(evt);
            }
        });
        internalFrame6.add(NoRmBayi1);
        NoRmBayi1.setBounds(100, 50, 100, 23);

        jLabel41.setText("No.R.M.Bayi 2 :");
        jLabel41.setName("jLabel41"); // NOI18N
        internalFrame6.add(jLabel41);
        jLabel41.setBounds(10, 50, 87, 23);

        BtnHapusGabung1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/stop_f2.png"))); // NOI18N
        BtnHapusGabung1.setMnemonic('H');
        BtnHapusGabung1.setText("Hapus");
        BtnHapusGabung1.setToolTipText("Alt+H");
        BtnHapusGabung1.setName("BtnHapusGabung1"); // NOI18N
        BtnHapusGabung1.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnHapusGabung1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnHapusGabung1ActionPerformed(evt);
            }
        });
        internalFrame6.add(BtnHapusGabung1);
        BtnHapusGabung1.setBounds(500, 45, 100, 30);

        NmBayi2.setEditable(false);
        NmBayi2.setName("NmBayi2"); // NOI18N
        internalFrame6.add(NmBayi2);
        NmBayi2.setBounds(200, 80, 300, 23);

        NoRmBayi2.setName("NoRmBayi2"); // NOI18N
        NoRmBayi2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NoRmBayi2KeyPressed(evt);
            }
        });
        internalFrame6.add(NoRmBayi2);
        NoRmBayi2.setBounds(100, 80, 100, 23);

        jLabel42.setText("No.R.M.Bayi 3 :");
        jLabel42.setName("jLabel42"); // NOI18N
        internalFrame6.add(jLabel42);
        jLabel42.setBounds(10, 80, 87, 23);

        BtnHapusGabung2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/stop_f2.png"))); // NOI18N
        BtnHapusGabung2.setMnemonic('H');
        BtnHapusGabung2.setText("Hapus");
        BtnHapusGabung2.setToolTipText("Alt+H");
        BtnHapusGabung2.setName("BtnHapusGabung2"); // NOI18N
        BtnHapusGabung2.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnHapusGabung2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnHapusGabung2ActionPerformed(evt);
            }
        });
        internalFrame6.add(BtnHapusGabung2);
        BtnHapusGabung2.setBounds(500, 75, 100, 30);
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-07-2022" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-07-2022" }));
            ...
            if(evt.getClickCount()==1){
                if(gabungkan.equals("gabung")){
                    if(norawat.getText().equals(norawatgabung)){
                        ...
                        ceknomor = Sequel.cariInteger("select count(ranap_gabung.no_rawat) from ranap_gabung INNER JOIN reg_periksa on ranap_gabung.no_rawat = reg_periksa.no_rawat where ranap_gabung.no_rawat=?",norawat.getText());
                          if(ceknomor == 0){
                            if(Sequel.menyimpantf("ranap_gabung","?,?","Data Ranap Gabung",2,new String[]{
                                    norawat.getText(),norawatgabung
                                })==true){
                                Sequel.mengedit("kamar_inap","no_rawat='"+norawatgabung+"'","gabung='1'"); 
                            ...
                            JOptionPane.showMessageDialog(null,"Bayi 1 Berhasil Digabungkan");
                          } else {
                            gabungkan="";
                            norawatgabung="";
                            JOptionPane.showMessageDialog(null,"Maaf, Data Penggabungan Bayi 1 Sudah Ada !!!"); 
                          }
                        }else{
                            gabungkan="";
                            norawatgabung="";
                ...
                if(gabungkan.equals("gabung2")){
                    if(norawat.getText().equals(norawatgabung)){
                        ...
                        int reply = JOptionPane.showConfirmDialog(rootPane,"Eeiiiiiits, udah bener belum data yang mau digabung..??","Konfirmasi",JOptionPane.YES_NO_OPTION);
                        if (reply == JOptionPane.YES_OPTION) {
                        ceknomor = Sequel.cariInteger("select count(ranap_gabung2.no_rawat) from ranap_gabung2 INNER JOIN reg_periksa on ranap_gabung2.no_rawat = reg_periksa.no_rawat where ranap_gabung2.no_rawat=?",norawat.getText());
                          if(ceknomor == 0){
                            if(Sequel.menyimpantf("ranap_gabung2","?,?","Data Ranap Gabung",2,new String[]{
                                    norawat.getText(),norawatgabung
                                })==true){
                                Sequel.mengedit("kamar_inap","no_rawat='"+norawatgabung+"'","gabung='2'"); 
                                Sequel.mengedit("kamar_inap","no_rawat='"+norawatgabung+"'","stts_pulang='Pindah Kamar'");
                                Sequel.mengedit("kamar","kd_kamar='"+kamaryangdigabung+"'","status='KOSONG'");                
                                Sequel.mengedit("kamar_inap","no_rawat='"+norawatgabung+"'","no_rawat='"+norawat.getText()+"'"); 
                                Sequel.mengedit("reg_periksa","no_rawat='"+norawatgabung+"'","status_lanjut='Ranap'");
                            ...
                            JOptionPane.showMessageDialog(null,"Bayi 2 Berhasil Digabungkan");
                          } else {
                            gabungkan="";
                            norawatgabung="";
                            JOptionPane.showMessageDialog(null,"Maaf, Data Penggabungan Bayi 2 Sudah Ada !!!"); 
                          }
                        }else{
                            gabungkan="";
                            norawatgabung="";
                ...
                if(gabungkan.equals("gabung3")){
                    if(norawat.getText().equals(norawatgabung)){
                        ...
                        int reply = JOptionPane.showConfirmDialog(rootPane,"Eeiiiiiits, udah bener belum data yang mau digabung..??","Konfirmasi",JOptionPane.YES_NO_OPTION);
                        if (reply == JOptionPane.YES_OPTION) {
                        ceknomor = Sequel.cariInteger("select count(ranap_gabung3.no_rawat) from ranap_gabung3 INNER JOIN reg_periksa on ranap_gabung3.no_rawat = reg_periksa.no_rawat where ranap_gabung3.no_rawat=?",norawat.getText());
                          if(ceknomor == 0){
                            if(Sequel.menyimpantf("ranap_gabung3","?,?","Data Ranap Gabung",2,new String[]{
                                    norawat.getText(),norawatgabung
                                })==true){
                                Sequel.mengedit("kamar_inap","no_rawat='"+norawatgabung+"'","gabung='3'"); 
                                Sequel.mengedit("kamar_inap","no_rawat='"+norawatgabung+"'","stts_pulang='Pindah Kamar'");
                                Sequel.mengedit("kamar","kd_kamar='"+kamaryangdigabung+"'","status='KOSONG'");                
                                Sequel.mengedit("kamar_inap","no_rawat='"+norawatgabung+"'","no_rawat='"+norawat.getText()+"'"); 
                                Sequel.mengedit("reg_periksa","no_rawat='"+norawatgabung+"'","status_lanjut='Ranap'"); 
                            ...
                            JOptionPane.showMessageDialog(null,"Bayi 3 Berhasil Digabungkan");
                          } else {
                            gabungkan="";
                            norawatgabung="";
                            JOptionPane.showMessageDialog(null,"Maaf, Data Penggabungan Bayi 3 Sudah Ada !!!"); 
                          }
                        }else{
                            gabungkan="";
                            norawatgabung="";
...
private void MnRujukMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRujukMasukActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbKamIn.getSelectedRow()>-1){
                if(Sequel.cariRegistrasi(norawat.getText())>0){
                    ...
                    Sequel.cariIsi("select no_rawat2 from ranap_gabung2 where no_rawat=?",NoRawatGabung,norawat.getText());
                    Sequel.cariIsi("select no_rkm_medis from reg_periksa where no_rawat=?",NoRmBayi1,NoRawatGabung.getText());
                    Sequel.cariIsi("select nm_pasien from pasien where no_rkm_medis=?",NmBayi1,NoRmBayi1.getText());
                    
                    Sequel.cariIsi("select no_rawat2 from ranap_gabung3 where no_rawat=?",NoRawatGabung,norawat.getText());
                    Sequel.cariIsi("select no_rkm_medis from reg_periksa where no_rawat=?",NoRmBayi2,NoRawatGabung.getText());
                    Sequel.cariIsi("select nm_pasien from pasien where no_rkm_medis=?",NmBayi2,NoRmBayi2.getText());
    ...
    private void barcodeRMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_barcodeRMActionPerformed
        if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            ...
            param.put("propinsirs",akses.getpropinsirs());
            param.put("kontakrs",akses.getkontakrs());
            param.put("umurnow",Sequel.cariIsi("SELECT umur FROM pasien join reg_periksa on reg_periksa.no_rkm_medis = pasien.no_rkm_medis WHERE reg_periksa.no_rawat=?",TNoRwCari.getText()));
            param.put("emailrs",akses.getemailrs());
            param.put("no_rawat",TNoRwCari.getText());
            param.put("norm",Sequel.cariIsi("select no_rkm_medis from reg_periksa where no_rawat=?", TNoRwCari.getText()));
            param.put("nama",Sequel.cariIsi("select nm_pasien FROM pasien join reg_periksa on reg_periksa.no_rkm_medis = pasien.no_rkm_medis Where reg_periksa.no_rawat=?",TNoRwCari.getText()));
            param.put("jkel",Sequel.cariIsi("select jk from pasien join reg_periksa on reg_periksa.no_rkm_medis = pasien.no_rkm_medis Where reg_periksa.no_rawat=?",TNoRwCari.getText()));
            param.put("tgl_lahir",Sequel.cariIsi("select tgl_lahir from pasien join reg_periksa on reg_periksa.no_rkm_medis = pasien.no_rkm_medis Where reg_periksa.no_rawat=?",TNoRwCari.getText()));
            //Limit LEFT biar sync ZAKE ZAKE ZAKE ZAKE param.put("png_jawab",Sequel.cariIsi("SELECT LEFT(png_jawab, 20) from penjab join reg_periksa on reg_periksa.kd_pj = penjab.kd_pj where reg_periksa.no_rawat=?",TNoRwCari.getText()));
            param.put("no_rawat",Sequel.cariIsi("select no_rawat from reg_periksa where no_rawat=?", TNoRwCari.getText()));
            param.put("nm_dokter",Sequel.cariIsi("select nm_dokter from dokter join reg_periksa on reg_periksa.kd_dokter = dokter.kd_dokter where reg_periksa.no_rawat=?",TNoRwCari.getText()));
            param.put("kelas",Sequel.cariIsi("SELECT UPPER(kelas) AS kelas FROM kamar JOIN kamar_inap ON kamar.kd_kamar = kamar_inap.kd_kamar JOIN reg_periksa ON reg_periksa.no_rawat = kamar_inap.no_rawat WHERE reg_periksa.no_rawat =?",TNoRwCari.getText()));
            param.put("logo",Sequel.cariGambar("select logo from setting"));
            Valid.MyReport("rptBarcodeRawat4-zV.jasper",param,"::[ Barcode No.RM ]::");
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_barcodeRMActionPerformed
            ...
            if(tbKamIn.getSelectedRow()>-1){
                if(tbKamIn.getValueAt(tbKamIn.getSelectedRow(),0).toString().equals("")){
                    try {
                        ...
                        param.put("pendidikan",Sequel.cariIsi("select pasien.pnd from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));             
                        param.put("agama",Sequel.cariIsi("select pasien.agama from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));             
                        param.put("pj",Sequel.cariIsi("select penjab.png_jawab from penjab INNER JOIN pasien ON penjab.kd_pj = pasien.kd_pj where pasien.no_rkm_medis=?",TNoRM.getText()));             
                        param.put("peserta",Sequel.cariIsi("select no_peserta from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));             
                        param.put("dokter",Sequel.cariIsi("SELECT dokter.nm_dokter from dokter INNER JOIN dpjp_ranap ON dokter.kd_dokter = dpjp_ranap.kd_dokter INNER join reg_periksa on reg_periksa.no_rawat = dpjp_ranap.no_rawat WHERE reg_periksa.no_rawat=?",norawat.getText()));             
                        //ngedit parameter zake zake zake zake zake zake zake zake zake zake zake zake zake zake zake 
                        param.put("tgl-masuk",Sequel.cariIsi("SELECT date_format(kamar_inap.tgl_masuk, '%d-%m-%Y') from kamar_inap INNER JOIN reg_periksa ON kamar_inap.no_rawat = reg_periksa.no_rawat WHERE reg_periksa.no_rawat=? LIMIT 1",norawat.getText()));             
                        param.put("jam-masuk",Sequel.cariIsi("SELECT kamar_inap.jam_masuk from kamar_inap INNER JOIN reg_periksa ON kamar_inap.no_rawat = reg_periksa.no_rawat WHERE reg_periksa.no_rawat=? LIMIT 1",norawat.getText()));             
                        param.put("diagnosa-awal",Sequel.cariIsi("SELECT kamar_inap.diagnosa_awal from kamar_inap INNER JOIN reg_periksa ON kamar_inap.no_rawat = reg_periksa.no_rawat WHERE reg_periksa.no_rawat=?",norawat.getText()));             
                        param.put("bangsa","Jawa/Indonesia");             
                        param.put("pekerjaan",Sequel.cariIsi("select pasien.agama from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));
                        param.put("status",Sequel.cariIsi("select pasien.stts_nikah from pasien where pasien.no_rkm_medis=?",TNoRM.getText()));
                        param.put("alamat",tbKamIn.getValueAt(tbKamIn.getSelectedRow(),3).toString());
    ...
    private void MnPenilaianAwalKeperawatanRanapUmumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianAwalKeperawatanRanapUmumActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_MnPenilaianAwalKeperawatanRanapUmumActionPerformed

    private void barcodeRIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_barcodeRIActionPerformed
        // TODO add your handling code here:
        if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
        }else{
            ...
            param.put("jkel",Sequel.cariIsi("select jk from pasien join reg_periksa on reg_periksa.no_rkm_medis = pasien.no_rkm_medis Where reg_periksa.no_rawat=?",TNoRwCari.getText()));
            param.put("tgl_lahir",Sequel.cariIsi("select tgl_lahir from pasien join reg_periksa on reg_periksa.no_rkm_medis = pasien.no_rkm_medis Where reg_periksa.no_rawat=?",TNoRwCari.getText()));
            param.put("tgl_masuk",Sequel.cariIsi("SELECT DATE_FORMAT(tgl_masuk,\"%d/%m/%Y\") FROM `kamar_inap` join reg_periksa ON reg_periksa.no_rawat = kamar_inap.no_rawat WHERE reg_periksa.no_rawat=?",TNoRwCari.getText()));
            //Limit LEFT biar sync ZAKE ZAKE ZAKE ZAKE param.put("png_jawab",Sequel.cariIsi("SELECT LEFT(png_jawab, 20) from penjab join reg_periksa on reg_periksa.kd_pj = penjab.kd_pj where reg_periksa.no_rawat=?",TNoRwCari.getText()));
            param.put("no_rawat",Sequel.cariIsi("select no_rawat from reg_periksa where no_rawat=?", TNoRwCari.getText()));
            param.put("nm_dokter",Sequel.cariIsi("select nm_dokter from dokter join reg_periksa on reg_periksa.kd_dokter = dokter.kd_dokter where reg_periksa.no_rawat=?",TNoRwCari.getText()));
            param.put("kelas",Sequel.cariIsi("SELECT UPPER(kelas) AS kelas FROM kamar JOIN kamar_inap ON kamar.kd_kamar = kamar_inap.kd_kamar JOIN reg_periksa ON reg_periksa.no_rawat = kamar_inap.no_rawat WHERE reg_periksa.no_rawat =?",TNoRwCari.getText()));
            param.put("logo",Sequel.cariGambar("select logo from setting"));
            Valid.MyReport("rptBarcodeRawat5-zV.jasper",param,"::[ Barcode Rawat Inap ]::");
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_barcodeRIActionPerformed
            ...
            if(cmbStatus.getSelectedItem().equals("-")){
                ...
                Sequel.mengedit("kamar_inap","no_rawat='"+norawat.getText()+"' and kd_kamar='"+kdkamar.getText()+"' and tgl_masuk='"+TIn.getText()+"' and jam_masuk='"+JamMasuk.getText()+"'",
                    ...
                    if(cmbStatus.getSelectedItem().equals("Meninggal")){
                        ...
                        tgl_masuk_inap = Sequel.cariIsi("Select tgl_masuk from kamar_inap where no_rawat='"+norawat.getText()+"'"); 
                        jam_masuk_inap = Sequel.cariIsi("Select jam_masuk from kamar_inap where no_rawat='"+norawat.getText()+"'");                
                        ...
                        dlgPasienMati.setTglMasuk(tgl_masuk_inap); 
                        dlgPasienMati.setJamMasuk(jam_masuk_inap);
    ...
    private void MnGabungkanRanap1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnGabungkanRanap1ActionPerformed
        // TODO add your handling code here:
        if(Sequel.cariRegistrasi(TNoRwCari.getText())>0){
            JOptionPane.showMessageDialog(rootPane,"Data billing sudah terverifikasi.\nSilahkan hubungi bagian kasir/keuangan ..!!");
        } else {
            if(Sequel.cariIsiAngka("Select count(no_rawat) from kamar_inap where no_rawat='"+norawat.getText()+"' and tgl_keluar='0000-00-00'") > 0){
                JOptionPane.showMessageDialog(null,"Maaf, Pasien Harus di pulangkan terlebih dahulu...!!!!");
            } else {
                if(tabMode.getRowCount()==0){
                    JOptionPane.showMessageDialog(null,"Maaf, data kamar inap pasien sudah habis...!!!!");
                    BtnIn.requestFocus();
    ...
    }//GEN-LAST:event_MnGabungkanRanap1ActionPerformed

    private void MnGabungkanRanap2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnGabungkanRanap2ActionPerformed
        // TODO add your handling code here:
        if(Sequel.cariRegistrasi(TNoRwCari.getText())>0){
            JOptionPane.showMessageDialog(rootPane,"Data billing sudah terverifikasi.\nSilahkan hubungi bagian kasir/keuangan ..!!");
        } else {
    ...
    }//GEN-LAST:event_MnGabungkanRanap2ActionPerformed
    ...
    private void BtnHapusGabungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusGabungActionPerformed
        Sequel.mengedit("kamar_inap","no_rawat='"+norawat.getText()+"' and gabung='1' ","no_rawat='"+Sequel.cariIsi("select no_rawat2 from ranap_gabung where no_rawat=?",norawat.getText())+"', gabung='' ");
    ...
    private void NoRmBayi1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoRmBayi1KeyPressed
        // TODO add your handling code here:
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            Sequel.cariIsi("select nm_pasien from pasien where no_rkm_medis=?",NmBayi1,NoRmBayi1.getText());
        }
    }//GEN-LAST:event_NoRmBayi1KeyPressed

    private void BtnHapusGabung1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusGabung1ActionPerformed
        // TODO add your handling code here:
        Sequel.mengedit("kamar_inap","no_rawat='"+norawat.getText()+"' and gabung='2' ","no_rawat='"+Sequel.cariIsi("select no_rawat2 from ranap_gabung2 where no_rawat=?",norawat.getText())+"', gabung='' ");
        Sequel.meghapus("ranap_gabung2","no_rawat",norawat.getText());
        NoRawatGabung.setText("");
        NoRmBayi1.setText("");
        NmBayi1.setText("");
        tampil();
    }//GEN-LAST:event_BtnHapusGabung1ActionPerformed

    private void NoRmBayi2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoRmBayi2KeyPressed
        // TODO add your handling code here:
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            Sequel.cariIsi("select nm_pasien from pasien where no_rkm_medis=?",NmBayi2,NoRmBayi2.getText());
        }
    }//GEN-LAST:event_NoRmBayi2KeyPressed

    private void BtnHapusGabung2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusGabung2ActionPerformed
        // TODO add your handling code here:
        Sequel.mengedit("kamar_inap","no_rawat='"+norawat.getText()+"' and gabung='3' ","no_rawat='"+Sequel.cariIsi("select no_rawat2 from ranap_gabung3 where no_rawat=?",norawat.getText())+"', gabung='' ");
        Sequel.meghapus("ranap_gabung3","no_rawat",norawat.getText());
        NoRawatGabung.setText("");
        NoRmBayi2.setText("");
        NmBayi2.setText("");
        tampil();
    }//GEN-LAST:event_BtnHapusGabung2ActionPerformed
    ...
    */
    ...
    private widget.Button BtnHapusGabung1;
    private widget.Button BtnHapusGabung2;
    ...
    private javax.swing.JMenuItem MnGabungkanRanap1;
    private javax.swing.JMenuItem MnGabungkanRanap2;
    ...
    private javax.swing.JMenuItem MnPenilaianAwalKeperawatanRanapUmum;
    ...
    private widget.TextBox NmBayi2;
    private widget.TextBox NoRawatGabung;
    private widget.TextBox NoRmBayi;
    private widget.TextBox NoRmBayi1;
    private widget.TextBox NoRmBayi2;
    ...
    private javax.swing.JMenuItem barcodeRI;
    private javax.swing.JMenuItem barcodeRM;
        ...
        try{
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    psanak2=koneksi.prepareStatement(
                        "select pasien.no_rkm_medis,pasien.nm_pasien,ranap_gabung2.no_rawat2,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.no_peserta, "+
                        "concat(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj) as alamat "+
                        "from reg_periksa inner join pasien on pasien.no_rkm_medis=reg_periksa.no_rkm_medis "+
                        "inner join ranap_gabung2 on ranap_gabung2.no_rawat2=reg_periksa.no_rawat where ranap_gabung2.no_rawat=?"); 
                    
                    psanak3=koneksi.prepareStatement(
                        "select pasien.no_rkm_medis,pasien.nm_pasien,ranap_gabung3.no_rawat2,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.no_peserta, "+
                        "concat(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj) as alamat "+
                        "from reg_periksa inner join pasien on pasien.no_rkm_medis=reg_periksa.no_rkm_medis "+
                        "inner join ranap_gabung3 on ranap_gabung3.no_rawat2=reg_periksa.no_rawat where ranap_gabung3.no_rawat=?"); 
                    try {
                        ...
                        psanak2.setString(1,rs.getString(1));
                        rs2=psanak2.executeQuery();
                        if(rs2.next()){
                            tabMode.addRow(new String[]{
                                "",rs2.getString("no_rkm_medis"),rs2.getString("nm_pasien")+" ("+rs2.getString("umur")+")",
                                rs.getString("alamat"),rs.getString("p_jawab"),rs.getString("hubunganpj"),rs.getString("png_jawab"),
                        ...
                        psanak3.setString(1,rs.getString(1));
                        rs2=psanak3.executeQuery();
                        if(rs2.next()){
                            tabMode.addRow(new String[]{
                                "",rs2.getString("no_rkm_medis"),rs2.getString("nm_pasien")+" ("+rs2.getString("umur")+")",
                                rs.getString("alamat"),rs.getString("p_jawab"),rs.getString("hubunganpj"),rs.getString("png_jawab"),
    ...
    public void isCek(){
        ...
        MnGabungkanRanap1.setEnabled(akses.getkamar_inap());
        MnGabungkanRanap2.setEnabled(akses.getkamar_inap());
        ...
        MnPenilaianAwalKeperawatanRanapUmum.setEnabled(akses.getpenilaian_awal_keperawatan_ranap());
