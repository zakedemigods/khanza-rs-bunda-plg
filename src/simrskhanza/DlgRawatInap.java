...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnAwalKeperawatanRanap = new widget.Button();
        ...
        BtnAwalKeperawatanRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalKeperawatanRanap.setText("Awal Keperawatan Ranap");
        BtnAwalKeperawatanRanap.setFocusPainted(false);
        BtnAwalKeperawatanRanap.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalKeperawatanRanap.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalKeperawatanRanap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalKeperawatanRanap.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalKeperawatanRanap.setName("BtnAwalKeperawatanRanap"); // NOI18N
        BtnAwalKeperawatanRanap.setPreferredSize(new java.awt.Dimension(180, 23));
        BtnAwalKeperawatanRanap.setRoundRect(false);
        BtnAwalKeperawatanRanap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalKeperawatanRanapActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalKeperawatanRanap);
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnAwalKeperawatanRanapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalKeperawatanRanapActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnAwalKeperawatanRanapActionPerformed
    ...
    */
    ...
    private widget.Button BtnAwalKeperawatanRanap;
    ...
    public void isCek(){
        ...
        BtnAwalKeperawatanRanap.setEnabled(akses.getpenilaian_awal_keperawatan_ranap());   
