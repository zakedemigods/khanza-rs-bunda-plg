...
public final class KeuanganPenagihanPiutangPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penagihan Piutang Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void MnDetailPiutangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDetailPiutangActionPerformed
    ...
    */
    ...
    private void autoNomor() {
       Valid.autoNomerSuratPenagihan("select ifnull(MAX(CONVERT(LEFT(no_tagihan,3),signed)),0) from penagihan_piutang where "
                + "tanggal like '%" + Valid.SetTgl(Tanggal.getSelectedItem() + "").substring(0, 7) + "%' ", "/KEU.9/RSB.11/" + Sequel.cariIsi("SELECT toRoman (MONTH(NOW())) as tgl") + "/" + Valid.SetTgl(Tanggal.getSelectedItem() + "").substring(0, 4), 3, NoPenagihan);
    }
}
