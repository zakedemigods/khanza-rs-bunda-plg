...
public class KeuanganCariPenagihanPiutangPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppSuratPengantar.setText("Surat Pengantar");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Penagihan Piutang Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormPhoto.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), " Bukti Penagihan/Bayar : ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void ppSuratPengantarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppSuratPengantarActionPerformed
        if(tbDokter.getSelectedRow()> -1){
            if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
                ...
                param.put("tanggal-indo",Sequel.cariIsi("SELECT date_format(tanggal,'%d %M %Y') FROM penagihan_piutang WHERE no_tagihan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString().trim()));
    ...
    */
    ...
    public void isCek(){
        ...
        if(akses.getkode().equals("Admin Utama")){
            ...
            ppHapus.setEnabled(akses.getakun_piutang());
        }
