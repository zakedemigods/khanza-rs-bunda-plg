    ...
    */
    ...
    private void tampil(String user) {        
        try{    
            ...
            ps=koneksi.prepareStatement(
                ...
                "user.pembayaran_briva,user.penilaian_awal_keperawatan_ranap,user.nilai_penerimaan_vendor_farmasi_perbulan,user.akun_bayar_hutang,user.hitung_bor_dinkes,user.master_rencana_keperawatan from user where user.id_user=AES_ENCRYPT(?,'nur')");
            try {
                ps.setString(1,user);
                rs=ps.executeQuery();
                while(rs.next()){
                    ...
                    if("[I]Hitung BOR DINKES".toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{false,"[I]Hitung BOR DINKES",rs.getBoolean("hitung_bor_dinkes")});
                    }
    ...
    private void Simpan() {
        for(i=0;i<tbUser.getRowCount();i++){ 
            ...
            if("[I]Hitung BOR DINKES".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","hitung_bor_dinkes='"+tbUser.getValueAt(i,2).toString()+"'");
            }
