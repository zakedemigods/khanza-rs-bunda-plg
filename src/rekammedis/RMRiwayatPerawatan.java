...
public final class RMRiwayatPerawatan extends javax.swing.JDialog {    
    ...
    public RMRiwayatPerawatan(java.awt.Frame parent, boolean modal) {
        ...
        tabModeRegistrasi=new DefaultTableModel(null,new Object[]{
                "No.","No.Rawat","Tanggal","Jam","Kd.Dokter","Dokter Dituju/DPJP","Umur","Poliklinik/Kamar","Jenis Bayar","Tindakan Operasi","Status Bayar"
            }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Riwayat/Rincian Tindakan/Terapi Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormMenu.setPreferredSize(new java.awt.Dimension(255, 1025));
        ...
        chkAsuhanKeperawatanRalan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chkAsuhanKeperawatanRalanActionPerformed(evt);
            }
        });
...
private void BtnPasienKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnPasienKeyPressed
    ...
    private void chkAsuhanKeperawatanRalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkAsuhanKeperawatanRalanActionPerformed
        // TODO add your handling code here:
    ...
    private void tampilKunjungan() {
        ...
        try{   
            if(R1.isSelected()==true){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,reg_periksa.status_lanjut,reg_periksa.kd_dokter,"+
                    "dokter.nm_dokter,reg_periksa.umurdaftar,reg_periksa.sttsumur,poliklinik.kd_poli,poliklinik.nm_poli,penjab.png_jawab, "+
                    "paket_operasi.nm_perawatan,reg_periksa.status_bayar from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join "+
                    "poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join penjab  on reg_periksa.kd_pj=penjab.kd_pj LEFT JOIN operasi "+
                    "ON reg_periksa.no_rawat=operasi.no_rawat LEFT JOIN paket_operasi ON operasi.kode_paket=paket_operasi.kode_paket where reg_periksa.stts<>'Batal' "+
                    "and reg_periksa.no_rkm_medis=? order by reg_periksa.tgl_registrasi desc limit 10");
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join penjab  on reg_periksa.kd_pj=penjab.kd_pj LEFT JOIN operasi "+
                    "ON reg_periksa.no_rawat=operasi.no_rawat LEFT JOIN paket_operasi ON operasi.kode_paket=paket_operasi.kode_paket where reg_periksa.stts<>'Batal' "+
                    "and reg_periksa.no_rkm_medis=? order by reg_periksa.tgl_registrasi");
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join penjab  on reg_periksa.kd_pj=penjab.kd_pj LEFT JOIN operasi "+
                    "ON reg_periksa.no_rawat=operasi.no_rawat LEFT JOIN paket_operasi ON operasi.kode_paket=paket_operasi.kode_paket where reg_periksa.stts<>'Batal' "+
                    "and reg_periksa.no_rkm_medis=? and reg_periksa.tgl_registrasi between ? and ? order by reg_periksa.tgl_registrasi");
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabModeRegistrasi.addRow(new String[]{
                        ...
                        rs.getString("kd_poli")+" "+rs.getString("nm_poli"),rs.getString("png_jawab"),rs.getString("nm_perawatan"),rs.getString("status_bayar")
                    });
                    ...
                    try {
                        ...
                        while(rs2.next()){                            
                            tabModeRegistrasi.addRow(new String[]{
                                ...
                                rs2.getString("kd_poli")+" "+rs2.getString("nm_poli"),rs.getString("png_jawab"),rs.getString("nm_perawatan"),rs.getString("status_bayar")
                            });
                        }
                    } catch (Exception e) {
                    ...
                    try {
                        ...
                        while(rs2.next()){                            
                            tabModeRegistrasi.addRow(new String[]{
                                ...
                                rs2.getString("kd_kamar")+" "+rs2.getString("nm_bangsal"),rs.getString("png_jawab"),rs.getString("nm_perawatan"),rs.getString("status_bayar")
                            });
                        }
                    } catch (Exception e) {
        ...
        try{   
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    //menampilkan asuhan awal keperawatan rawat inap
                    if(chkAsuhanKeperawatanRanap.isSelected()==true){
                        try {
                            rs2=koneksi.prepareStatement(
                                    ...
                                    "inner join dokter on penilaian_awal_keperawatan_ranap.kd_dokter=dokter.kd_dokter where penilaian_awal_keperawatan_ranap.no_rawat='"+rs.getString("no_rawat")+"'").executeQuery();
                            if(rs2.next()){
                                htmlContent.append(
                                  "<tr class='isi'>"+ 
                                    "<td valign='top' width='2%'></td>"+        
                                ...
                                while(rs2.next()){
                                    ...
                                    try {
                                        rs3=koneksi.prepareStatement(
                                            ...
                                            "where penilaian_awal_keperawatan_ranap_masalah.no_rawat='"+rs.getString("no_rawat")+"' order by penilaian_awal_keperawatan_ranap_masalah.kode_masalah").executeQuery();
                                        while(rs3.next()){
                                            htmlContent.append(rs3.getString("nama_masalah")+"<br>");
                                        }
                                    } catch (Exception e) {
                                    ...
                                    try {
                                        rs3=koneksi.prepareStatement(
                                            ...
                                            "where penilaian_awal_keperawatan_ranap_rencana.no_rawat='"+rs.getString("no_rawat")+"' order by penilaian_awal_keperawatan_ranap_rencana.kode_rencana").executeQuery();
                                        while(rs3.next()){
