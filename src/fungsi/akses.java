...
public final class akses {
    ...
    private static boolean aktif=false,admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            pembayaran_briva=false,penilaian_awal_keperawatan_ranap=false,nilai_penerimaan_vendor_farmasi_perbulan=false,akun_bayar_hutang=false,hitung_bor_dinkes=false,master_rencana_keperawatan=false;
       ...
       try {                
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        akses.hitung_bor_dinkes=rs2.getBoolean("hitung_bor_dinkes");
    ...
    public static boolean gethitung_bor_dinkes(){return akses.hitung_bor_dinkes;}
