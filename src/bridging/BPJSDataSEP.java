...
public final class BPJSDataSEP extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppSEPBunda = new javax.swing.JMenuItem();
        ppSJP = new javax.swing.JMenuItem();
        ppLabelBarcode = new javax.swing.JMenuItem();
        ...
        ppSEPBunda.setBackground(new java.awt.Color(255, 255, 254));
        ppSEPBunda.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppSEPBunda.setForeground(new java.awt.Color(50, 50, 50));
        ppSEPBunda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppSEPBunda.setText("Print SEP");
        ppSEPBunda.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppSEPBunda.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppSEPBunda.setName("ppSEPBunda"); // NOI18N
        ppSEPBunda.setPreferredSize(new java.awt.Dimension(300, 25));
        ppSEPBunda.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppSEPBundaBtnPrintActionPerformed(evt);
            }
        });
        Popup.add(ppSEPBunda);

        ppSJP.setBackground(new java.awt.Color(255, 255, 254));
        ppSJP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppSJP.setForeground(new java.awt.Color(50, 50, 50));
        ppSJP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppSJP.setText("Print SJP ");
        ppSJP.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppSJP.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppSJP.setName("ppSJP"); // NOI18N
        ppSJP.setPreferredSize(new java.awt.Dimension(300, 25));
        ppSJP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppSJPBtnPrintActionPerformed(evt);
            }
        });
        Popup.add(ppSJP);

        ppLabelBarcode.setBackground(new java.awt.Color(255, 255, 254));
        ppLabelBarcode.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppLabelBarcode.setForeground(new java.awt.Color(50, 50, 50));
        ppLabelBarcode.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppLabelBarcode.setText("Print Label Barcode");
        ppLabelBarcode.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppLabelBarcode.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppLabelBarcode.setName("ppLabelBarcode"); // NOI18N
        ppLabelBarcode.setPreferredSize(new java.awt.Dimension(300, 25));
        ppLabelBarcode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppLabelBarcodeBtnPrintActionPerformed(evt);
            }
        });
        Popup.add(ppLabelBarcode);
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2022 09:06:43" }));
        ...
        TanggalKematian.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2022" }));
        ...
        TanggalRujukKeluar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2022" }));
        ...
        TanggalKunjungRujukan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2022" }));
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2022" }));
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2022" }));
        ...
        TanggalKKL.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2022" }));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2022" }));
        ...
        DTPCariInternal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2022" }));
        ...
        DTPCariInternal2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "31-03-2022" }));
        ...
        if(tabMode.getRowCount()!=0){
            ...
            if(evt.getClickCount()==2){
                ...
                if(i==0){
                    ...
                    ppSEPBundaBtnPrintActionPerformed(null);
                }else if(i==2){
    ...
    private void ppSJPBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppSJPBtnPrintActionPerformed
        //SJP Ralan (Non Internal Dan Internal) start:
        if(TabRawat.getSelectedIndex()==1){
            if(tbDataSEP.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR)); 
                Map<String, Object> param = new HashMap<>();
                ...
                param.put("propinsirs",akses.getpropinsirs());
                param.put("kontakrs",akses.getkontakrs());
                param.put("tgl_sep",Sequel.cariIsi("SELECT DATE_FORMAT(tglsep, '%d %M %Y') FROM `bridging_sep` WHERE no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("tgl_pulang",Sequel.cariIsi("SELECT DATE_FORMAT(tglpulang, '%d %M %Y') FROM `bridging_sep` WHERE no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("tgl_rujukan",Sequel.cariIsi("SELECT DATE_FORMAT(tglrujukan, '%d %M %Y') FROM `bridging_sep` WHERE no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("alamat",Sequel.cariIsi("SELECT alamat FROM pasien join bridging_sep on pasien.no_rkm_medis = bridging_sep.nomr WHERE bridging_sep.no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("tgl_lahir",Sequel.cariIsi("SELECT DATE_FORMAT(tgl_lahir, '%d %M %Y') FROM pasien join bridging_sep on pasien.no_rkm_medis = bridging_sep.nomr WHERE bridging_sep.no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("logo",Sequel.cariGambar("select bpjs from gambar")); 
                param.put("prb",Sequel.cariIsi("select prb from bpjs_prb where no_sep=?",tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("parameter",tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString());
        if(JenisPelayanan.getSelectedIndex()==0){
                    Valid.MyReport("rptBridgingSJPRANAP.jasper","report","::[ Cetak SJP Ranap ]::",param);
            }else{
                Valid.MyReport("rptBridgingSJPRALAN.jasper","report","::[ Cetak SJP Ralan ]::",param);
                }                
                this.setCursor(Cursor.getDefaultCursor());
            }else{
            ...
            if(tbDataSEPInternal.getSelectedRow()!= -1){
                ...
                param.put("poliinternal",Sequel.cariIsi("select nmpolitujuan from bridging_sep_internal where no_sep=?",tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                
                param.put("tgl_sep",Sequel.cariIsi("SELECT DATE_FORMAT(tglsep, '%d %M %Y') FROM `bridging_sep_internal` WHERE no_sep=?", tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("tgl_pulang",Sequel.cariIsi("SELECT DATE_FORMAT(tglpulang, '%d %M %Y') FROM `bridging_sep_internal` WHERE no_sep=?", tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("tgl_rujukan",Sequel.cariIsi("SELECT DATE_FORMAT(tglrujukan, '%d %M %Y') FROM `bridging_sep_internal` WHERE no_sep=?", tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("alamat",Sequel.cariIsi("SELECT alamat FROM pasien join bridging_sep_internal on pasien.no_rkm_medis = bridging_sep_internal.nomr WHERE bridging_sep_internal.no_sep=?", tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("tgl_lahir",Sequel.cariIsi("SELECT DATE_FORMAT(tgl_lahir, '%d %M %Y') FROM pasien join bridging_sep_internal on pasien.no_rkm_medis = bridging_sep_internal.nomr WHERE bridging_sep_internal.no_sep=?", tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                
                param.put("prb",Sequel.cariIsi("select prb from bpjs_prb where no_sep=?",tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("logo",Sequel.cariGambar("select bpjs from gambar")); 
                param.put("kamar_tujuan",Sequel.cariIsi("SELECT bangsal.nm_bangsal FROM (((bangsal INNER JOIN kamar ON bangsal.kd_bangsal = kamar.kd_bangsal) INNER JOIN kamar_inap ON kamar.kd_kamar = kamar_inap.kd_kamar) INNER JOIN bridging_sep_internal ON kamar_inap.no_rawat = bridging_sep_internal.no_rawat) WHERE bridging_sep_internal.no_sep=?",tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("umurnow",Sequel.cariIsi("SELECT umur FROM pasien join bridging_sep_internal on bridging_sep_internal.nomr = pasien.no_rkm_medis WHERE bridging_sep_internal.no_sep=?",tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("parameter",tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString());
                if(JenisPelayanan.getSelectedIndex()==0){
                    Valid.MyReport("rptBridgingSJPRANAP-Internal.jasper","report","::[ Cetak SJP Internal Bunda Ranap ]::",param);
                }else{
                    Valid.MyReport("rptBridgingSJPRALAN-Internal.jasper","report","::[ Cetak SJP Internal Bunda Ralan ]::",param);
                }                
                this.setCursor(Cursor.getDefaultCursor());
            }else{
                JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data SJP yang mau dicetak...!!!!");
    ...
    }//GEN-LAST:event_ppSJPBtnPrintActionPerformed

    private void ppSEPBundaBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppSEPBundaBtnPrintActionPerformed
        // TODO add your handling code here:
        if(TabRawat.getSelectedIndex()==1){
            if(tbDataSEP.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR)); 
                ...
                param.put("prb",Sequel.cariIsi("select prb from bpjs_prb where no_sep=?",tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("logo",Sequel.cariGambar("select bpjs from gambar")); 
                param.put("kamar_tujuan",Sequel.cariIsi("SELECT bangsal.nm_bangsal FROM (((bangsal INNER JOIN kamar ON bangsal.kd_bangsal = kamar.kd_bangsal) INNER JOIN kamar_inap ON kamar.kd_kamar = kamar_inap.kd_kamar) INNER JOIN bridging_sep ON kamar_inap.no_rawat = bridging_sep.no_rawat) WHERE bridging_sep.no_sep=?",tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("umurnow",Sequel.cariIsi("SELECT umur FROM pasien join bridging_sep on bridging_sep.nomr = pasien.no_rkm_medis WHERE bridging_sep.no_sep=?",tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("tgl_lahir",Sequel.cariIsi("SELECT DATE_FORMAT(tgl_lahir, '%d/%m/%Y') FROM pasien join bridging_sep on pasien.no_rkm_medis = bridging_sep.nomr WHERE bridging_sep.no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("admin",Sequel.cariIsi("SELECT nama FROM pegawai join bridging_sep on bridging_sep.user = pegawai.nik WHERE bridging_sep.no_sep=?",tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("parameter",tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString());
                if(JenisPelayanan.getSelectedIndex()==0){
                    Valid.MyReport("rptBridgingSEPbundazV.jasper","report","::[ Cetak SEP Ranap ]::",param);
                }else{
                    Valid.MyReport("rptBridgingSEPbundaralanzV.jasper","report","::[ Cetak SEP Ralan ]::",param);
                }                
                this.setCursor(Cursor.getDefaultCursor());
            }else{
                JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data SEP yang mau dicetak...!!!!");
            ...
            if(tbDataSEPInternal.getSelectedRow()!= -1){
                ...
                param.put("dpjp",NmDPJP.getText());  
                param.put("poliinternal",Sequel.cariIsi("select nmpolitujuan from bridging_sep_internal where no_sep=?",tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("prb",Sequel.cariIsi("select prb from bpjs_prb where bridging_sep_internal=?",tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("logo",Sequel.cariGambar("select bpjs from gambar")); 
                param.put("kamar_tujuan",Sequel.cariIsi("SELECT bangsal.nm_bangsal FROM (((bangsal INNER JOIN kamar ON bangsal.kd_bangsal = kamar.kd_bangsal) INNER JOIN kamar_inap ON kamar.kd_kamar = kamar_inap.kd_kamar) INNER JOIN bridging_sep_internal ON kamar_inap.no_rawat = bridging_sep_internal.no_rawat) WHERE bridging_sep_internal.no_sep=?",tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("umurnow",Sequel.cariIsi("SELECT umur FROM pasien join bridging_sep_internal on bridging_sep_internal.nomr = pasien.no_rkm_medis WHERE bridging_sep_internal.no_sep=?",tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("tgl_lahir",Sequel.cariIsi("SELECT DATE_FORMAT(tgl_lahir, '%d/%m/%Y') FROM pasien join bridging_sep_internal on pasien.no_rkm_medis = bridging_sep_internal.nomr WHERE bridging_sep_internal.no_sep=?", tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("admin",Sequel.cariIsi("SELECT nama FROM pegawai join bridging_sep_internal on bridging_sep_internal.user = pegawai.nik WHERE bridging_sep_internal.no_sep=?",tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString()));
                param.put("parameter",tbDataSEPInternal.getValueAt(tbDataSEPInternal.getSelectedRow(),0).toString());
                if(JenisPelayanan.getSelectedIndex()==0){
                    Valid.MyReport("rptBridgingSEPbundaInternalzV.jasper","report","::[ Cetak SEP Internal Bunda Ranap ]::",param);
                }else{
                    Valid.MyReport("rptBridgingSEPbundaralanInternalzV.jasper","report","::[ Cetak SEP Internal Bunda Ralan]::",param);
                }                
                this.setCursor(Cursor.getDefaultCursor());
            }else{
                JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data SEP yang mau dicetak...!!!!");
    ...
    }//GEN-LAST:event_ppSEPBundaBtnPrintActionPerformed

    private void ppLabelBarcodeBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLabelBarcodeBtnPrintActionPerformed
        //Label Barcode ASTAGAZAKE
        if(TabRawat.getSelectedIndex()==1){
            if(tbDataSEP.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR)); 
                Map<String, Object> param = new HashMap<>();
                ...
                param.put("propinsirs",akses.getpropinsirs());
                param.put("kontakrs",akses.getkontakrs());
                param.put("norm",Sequel.cariIsi("select nomr from bridging_sep where no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("nama",Sequel.cariIsi("select nama_pasien from bridging_sep where no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("jkel",Sequel.cariIsi("select jkel from bridging_sep where no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("tgl_lahir",Sequel.cariIsi("select tanggal_lahir from bridging_sep where no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("umurnow",Sequel.cariIsi("SELECT umur FROM pasien join bridging_sep on bridging_sep.nomr = pasien.no_rkm_medis WHERE bridging_sep.no_sep=?",tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("png_jawab",Sequel.cariIsi("SELECT penjab.nama_perusahaan FROM ((penjab JOIN pasien ON pasien.kd_pj = penjab.kd_pj) JOIN bridging_sep ON bridging_sep.nama_pasien = pasien.nm_pasien) WHERE bridging_sep.no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("kd_poli",Sequel.cariIsi("select kdpolitujuan from bridging_sep where no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("tgl_registrasi",Sequel.cariIsi("select tgl_registrasi from reg_periksa where no_rkm_medis=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("no_rawat",Sequel.cariIsi("select no_rawat from bridging_sep where no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("nm_dokter",Sequel.cariIsi("select nmdpdjp from bridging_sep where no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("kelas",Sequel.cariIsi("select klsrawat from bridging_sep where no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("tgl_sep",Sequel.cariIsi("SELECT DATE_FORMAT(tglsep, '%d %M %Y') FROM `bridging_sep` WHERE no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("tgl_pulang",Sequel.cariIsi("SELECT DATE_FORMAT(tglpulang, '%d %M %Y') FROM `bridging_sep` WHERE no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("tgl_rujukan",Sequel.cariIsi("SELECT DATE_FORMAT(tglrujukan, '%d %M %Y') FROM `bridging_sep` WHERE no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                param.put("alamat",Sequel.cariIsi("SELECT alamat FROM pasien join bridging_sep on pasien.no_rkm_medis = bridging_sep.nomr WHERE bridging_sep.no_sep=?", tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString()));
                ...
                param.put("parameter",tbDataSEP.getValueAt(tbDataSEP.getSelectedRow(),0).toString());
        if(JenisPelayanan.getSelectedIndex()==0){
                    Valid.MyReport("rptBarcodeRawatPopupRanap.jasper","report","::[ Label Barcode Ranap ]::",param);
            }else{
                Valid.MyReport("rptBarcodeRawatPopup.jasper","report","::[ Label Barcode Ralan ]::",param);
                }                
                this.setCursor(Cursor.getDefaultCursor());
            }else{
                JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data SJP yang mau dicetak...!!!!");
    ...
    }//GEN-LAST:event_ppLabelBarcodeBtnPrintActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem ppLabelBarcode;
    ...
    private javax.swing.JMenuItem ppSEPBunda;
    private javax.swing.JMenuItem ppSJP;
    ...
    public void isCek(){
        ...
        ppSEPBunda.setEnabled(akses.getbpjs_sep());               
