...
public final class InhealthDataSJP extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-07-2022 11:33:25" }));
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-07-2022 11:33:25" }));
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-07-2022 11:33:25" }));
    ...
    private void ppSEPBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppSEPBtnPrintActionPerformed
        if(tbObat.getSelectedRow()!= -1){
            ...
            if(JenisPelayanan.getSelectedIndex()==2){
                Valid.MyReport("rptBridgingSJP.jasper","report","::[ Cetak SJP Jalan ]::",param);
            }else if(JenisPelayanan.getSelectedIndex()==3){
                Valid.MyReport("rptBridgingSJP2.jasper","report","::[ Cetak SJP Inap ]::",param);
            }                
            this.setCursor(Cursor.getDefaultCursor());
        }else{
