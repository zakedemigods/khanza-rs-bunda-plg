...
public class DlgCariPenjualan extends javax.swing.JDialog {
    ...
    public DlgCariPenjualan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.Nota","Tanggal","Jam Billing","Petugas","Pasien","Keterangan","Jns.Jual","PPN Obat","Asal Stok","","","","","","Ongkos Kirim","Akun Bayar"};
    ...
    private void initComponents() {
        ...
        BtnCloseIn4.setBounds(460, 30, 100, 30);
        ...
        CmbMenit.setBounds(140, 130, 62, 23);
        ...
        CmbDetik.setBounds(200, 130, 62, 23);
        ...
        ChkJln.setBounds(210, 160, 23, 23);
    ...
    private void ppCetakNotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCetakNotaActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
                ...
                Valid.panggilUrl("billing/NotaApotek2.php?petugas="+akses.getkode().replaceAll(" ","_")+"&nonota="+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
            }
        }            
        this.setCursor(Cursor.getDefaultCursor());
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    ...
    private void BtnSimpan4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan4ActionPerformed
        if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
            ...
            try {
               pscarijual=koneksi.prepareStatement(
                       "select penjualan.nota_jual,penjualan.kd_bangsal,penjualan.status,penjualan.no_rkm_medis,penjualan.nm_pasien,penjualan.tgl_jual,penjualan.ongkir,penjualan.ppn,penjualan.jam from penjualan where penjualan.nota_jual=?");
               try {
                  pscarijual.setString(1,tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
                  rs=pscarijual.executeQuery();
                  if(rs.next()){
                      if(rs.getString("status").equals("Sudah Dibayar")){
                         ...
                         Sequel.mengedit("penjualan","nota_jual=?","kd_rek=?,nama_bayar=?,jam=?",4,new String[]{
                             kdrek,AkunBayar.getSelectedItem().toString(),CmbJam.getSelectedItem()+":"+CmbMenit.getSelectedItem()+":"+CmbDetik.getSelectedItem(),
                         ...
                         if(sukses==true){
//                            Sequel.queryu2("update penjualan set jam=?,status='Sudah Dibayar' where nota_jual=?",3,
//                            new String[]{
//                                rs.getString("nota_jual"),CmbJam.getSelectedItem()+":"+CmbMenit.getSelectedItem()+":"+CmbDetik.getSelectedItem()
//                            }
//                            );
    ...
    private void tampil() {
        ...
        try{
            ...
            ps=koneksi.prepareStatement("select penjualan.nota_jual, penjualan.tgl_jual, "+
                    ...
                    " if(penjualan.status='Belum Dibayar','',penjualan.jam) as jam"+
            ...
            try {
                ...
                while(rs.next()){                    
                    tabMode.addRow(new String[]{
                        rs.getString(1),rs.getString(2),rs.getString(14),rs.getString(3)+", "+rs.getString(4),
