...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private String[] kodebarang,namabarang,kodesatuan,letakbarang,namajenis,aturan,industri,kategori,golongan,no,nobatch,nofaktur,kadaluarsa,keterangan;
    private String signa1="1",signa2="1",nokunjungan="",kdObatSK="",requestJson="",URL="",otorisasi,sql="",aktifpcare="no",no_batchcari="", tgl_kadaluarsacari="", no_fakturcari="", aktifkanbatch="no",kodedokter="",namadokter="",noresep="",bangsal="",bangsaldefault=Sequel.cariIsi("select set_lokasi.kd_bangsal from set_lokasi limit 1"),tampilkan_ppnobat_ralan="",
                   Suspen_Piutang_Obat_Ralan="",Obat_Ralan="",HPP_Obat_Rawat_Jalan="",Persediaan_Obat_Rawat_Jalan="",hppfarmasi="",VALIDASIULANGBERIOBAT="",DEPOAKTIFOBAT="";
    ...
    public DlgCariObat(java.awt.Frame parent, boolean modal) {
        ...
        tabModeobat=new DefaultTableModel(null,new Object[]{
                ...
                "H.Beli","Kategori","Golongan","No.Batch","No.Faktur","Kadaluarsa","Keterangan"
            }){
            @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if ((colIndex==0)||(colIndex==1)||(colIndex==8)||(colIndex==9)||(colIndex==11)||(colIndex==16)||(colIndex==17)||(colIndex==19)) {
                    a=true;
                }
                return a;
             }
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2022" }));
                                ...
                                try {
                                    ...
                                    if(carikapasitas.next()){ 
                                        if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",15,new String[]{
                                            ...
                                            "Ralan",kdgudang.getText(),tbObat.getValueAt(i,16).toString(),tbObat.getValueAt(i,17).toString(),tbObat.getValueAt(i,19).toString()
                                        })==true){
    ...
    public void tampilobat() {        
        ...
        for(i=0;i<tbObat.getRowCount();i++){
            if(!tbObat.getValueAt(i,1).toString().equals("")){
                ...
                keterangan[z]=tbObat.getValueAt(i,19).toString();
        ...
        for(i=0;i<z;i++){
            tabModeobat.addRow(new Object[] {
                ...
                eb[i],ts[i],stok[i],aturan[i],industri[i],beli[i],kategori[i],golongan[i],nobatch[i],nofaktur[i],kadaluarsa[i],keterangan[i]
            });
        }
            ...
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    psobat=koneksi.prepareStatement(
                        ...
                        " resep_dokter.jml, resep_dokter.aturan_pakai, resep_dokter.keterangan, kategori_barang.nama as kategori,golongan_barang.nama as golongan "+
                        ...
                        while(rsobat.next()){
                            ...
                            if(rsobat.getDouble("jml")>sisacari){
                                ...
                                tabModeobat.addRow(new Object[] {
                                   ...
                                   h_belicari,rsobat.getString("kategori"),rsobat.getString("golongan"),no_batchcari,no_fakturcari,tgl_kadaluarsacari,rsobat.getString("keterangan")
                                });   
                            }else{
                                tabModeobat.addRow(new Object[] {
                        ...
                        while(rsobat.next()){
                            ...
                            if(rsobat.getDouble("jml")>sisacari){
                                ...
                                tabModeobat.addRow(new Object[] {false,sisacari,rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                   rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("harga"),100),
                                   rsobat.getString("nama"),0,0,sisacari,rsobat.getString("aturan_pakai"),rsobat.getString("nama_industri"),
                                   rsobat.getDouble("dasar"),rsobat.getString("kategori"),rsobat.getString("golongan"),"","","",rsobat.getString("keterangan")
                                });   
                            }else{
                ...
                if(aktifkanbatch.equals("yes")){
                    psobat=koneksi.prepareStatement(
                        ...
                        "resep_dokter.aturan_pakai,resep_dokter.keterangan,kategori_barang.nama as kategori,golongan_barang.nama as golongan "+
                        " from databarang inner join jenis inner join golongan_barang inner join kategori_barang "+
                        " inner join industrifarmasi inner join resep_dokter on databarang.kdjns=jenis.kdjns "+
                        " and industrifarmasi.kode_industri=databarang.kode_industri "+
                        " and resep_dokter.kode_brng=databarang.kode_brng  "+
