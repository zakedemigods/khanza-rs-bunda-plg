...
public class DlgPenjualan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel9.setBounds(30, 110, 36, 23);
                ...
                try {
                    if(Valid.SetAngka(tabMode.getValueAt(i,0).toString())>0){
                        Sequel.menyimpan2("temporary","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",38,new String[]{
                            ...
                            tabMode.getValueAt(i,13).toString(),tabMode.getValueAt(i,14).toString(),tabMode.getValueAt(i,15).toString(),tabMode.getValueAt(i,16).toString(),"","","","","","","","","","","","","","","","","","","","",akses.getalamatip()
                        });
                        row++;
                    }
                } catch (Exception e) {
