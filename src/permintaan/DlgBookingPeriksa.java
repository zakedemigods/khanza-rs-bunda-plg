...
public class DlgBookingPeriksa extends javax.swing.JFrame {
    ...
    public DlgBookingPeriksa() {
        ...
        Object[] row={"No.Booking","Tgl.Booking","Tgl.Periksa","Nama","Tgl.Lahir","Alamat","No.Telp","E-Mail","Kode Poli","Unit/Poli","Tambahan Pesan","Status"};
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(830, 430));
        ...
        Alamat.setBounds(120, 110, 349, 23);

        jLabel15.setText("Alamat Pasien :");
        FormInput.add(jLabel15);
        jLabel15.setBounds(0, 110, 116, 23);
        ...
        Kelurahan.setBounds(120, 140, 142, 23);
        ...
        BtnKelurahan.setBounds(260, 140, 28, 23);
        ...
        BtnKecamatan.setBounds(440, 140, 28, 23);
        ...
        Kecamatan.setBounds(300, 140, 142, 23);
        ...
        Kabupaten.setBounds(120, 170, 142, 23);
        ...
        BtnKabupaten.setBounds(260, 170, 28, 23);
        ...
        Propinsi.setBounds(300, 170, 142, 23);
        ...
        BtnPropinsi.setBounds(440, 170, 28, 23);
        ...
        jLabel20.setBounds(440, 220, 70, 23);
        ...
        NmPoli.setBounds(580, 220, 185, 23);

        KdPoli.setEditable(false);
        KdPoli.setHighlighter(null);
        FormInput.add(KdPoli);
        KdPoli.setBounds(520, 220, 60, 23);

        jLabel55.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel55.setText("C. PENCARIAN JADWAl DOKTER & KUOTA TERSEDIA :");
        FormInput.add(jLabel55);
        jLabel55.setBounds(10, 250, 300, 23);

        jLabel9.setText("Dokter :");
        FormInput.add(jLabel9);
        jLabel9.setBounds(0, 270, 116, 23);

        KdDokter.setEditable(false);
        KdDokter.setHighlighter(null);
        FormInput.add(KdDokter);
        KdDokter.setBounds(120, 270, 100, 23);

        NmDokter.setEditable(false);
        NmDokter.setHighlighter(null);
        FormInput.add(NmDokter);
        NmDokter.setBounds(220, 270, 190, 23);
        ...
        BtnDokter.setBounds(420, 270, 28, 23);

        jLabel23.setText("Cara Bayar :");
        FormInput.add(jLabel23);
        jLabel23.setBounds(0, 300, 116, 23);

        kdpnj.setEditable(false);
        kdpnj.setHighlighter(null);
        FormInput.add(kdpnj);
        kdpnj.setBounds(120, 300, 70, 23);

        nmpnj.setEditable(false);
        FormInput.add(nmpnj);
        nmpnj.setBounds(190, 300, 220, 23);
        ...
        btnPenjab.setBounds(420, 300, 28, 23);

        jLabel24.setText("No.Reg :");
        FormInput.add(jLabel24);
        jLabel24.setBounds(630, 300, 70, 23);
        ...
        StatusBalas.setBounds(120, 380, 95, 23);
        ...
        BalasanPesan.setBounds(310, 380, 454, 23);

        jLabel31.setText("Pesan Balasan :");
        FormInput.add(jLabel31);
        jLabel31.setBounds(220, 380, 90, 23);
        ...
        jLabel32.setText("Tgl.Lahir :");
        FormInput.add(jLabel32);
        jLabel32.setBounds(0, 80, 116, 23);
        ...
        TanggalLahir.setBounds(120, 80, 270, 23);
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-08-2022" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-08-2022" }));
    ...
    private void tampil(){
        ...
        try{
            ...
            ps=koneksi.prepareStatement(
                    "select booking_periksa.no_booking,booking_periksa.tanggal,booking_periksa.nama,booking_periksa.tgl_lahir,booking_periksa.alamat,booking_periksa.no_telp,booking_periksa.email,booking_periksa.kd_poli,poliklinik.nm_poli,"+
                    "booking_periksa.tambahan_pesan,booking_periksa.status,booking_periksa.tanggal_booking from booking_periksa inner join poliklinik on booking_periksa.kd_poli=poliklinik.kd_poli "+
                    "where "+pilihtampil+(TCari.getText().trim().equals("")?"":" and (booking_periksa.no_booking like ? or booking_periksa.nama like ? or booking_periksa.alamat like ? or booking_periksa.no_telp like ? or "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        rs.getString("no_booking"),rs.getString("tanggal_booking"),rs.getString("tanggal"),rs.getString("nama"),rs.getString("tgl_lahir"),rs.getString("alamat"),rs.getString("no_telp"),
    ...
    private void getData(){
        if(tbObat.getSelectedRow()!= -1){
            ...
            TanggalLahir.setText(tbObat.getValueAt(tbObat.getSelectedRow(),4).toString());
            arrSplit = tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().toUpperCase().split(",");
            try {
            ...
            NoTelp.setText(tbObat.getValueAt(tbObat.getSelectedRow(),6).toString());
            ...
            TambahanPesan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
        }
    }
    ...
    private void isBooking() {
        ...
        if(StatusBalas.getSelectedItem().toString().equals("Diterima")){
            ...
            if(Sequel.menyimpantf2("pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rekam Medis Pasien",36,new String[]{
                    TNo.getText(),NamaPasien.getText(),"-",CmbJk.getSelectedItem().toString(),"-",TanggalLahir.getText(),"-",Alamat.getText().replaceAll("ALAMAT",""),
